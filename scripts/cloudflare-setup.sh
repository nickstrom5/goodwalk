#!/usr/bin/env bash
# One-shot Cloudflare setup for goodwalk.app: DNS for GitHub Pages + email forwarding.
...
#              Zone:DNS:Edit, Zone:Zone:Read, scoped to goodwalk.app.
set -euo pipefail

DOMAIN="${DOMAIN:-goodwalk.app}"
